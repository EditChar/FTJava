...
public class FT extends AppCompatActivity implements CountdownTimerHelper.TimerListener{
...
//                }
        ...
        ileri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (timerRunning) {
                    ...
                    secondsPassed += 1;
                    startTimer();
                    Toast.makeText(FT.this, "1sn ileri alındı.", Toast.LENGTH_SHORT).show();
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (timerRunning) {
                    secondsPassed -= 0.5;
                    Toast.makeText(FT.this, "0.5sn geri alındı.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
